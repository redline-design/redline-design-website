...
export default function Home() {
  ...
  return (
    <div>
      ...
      <ScrollAnimatedSection>
        <section className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section" data-testid="section-challenges">
      ...
      <ScrollAnimatedSection>
        <section className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section" data-testid="section-differentiators">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-lg sm:text-xl md:text-2xl font-bold uppercase tracking-[0.3em] mb-4 red-glow-pulse" style={{ color: "#ff0000" }}>
      ...
      <ScrollAnimatedSection>
        <section className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section" data-testid="section-why-us">
        <div className="max-w-7xl mx-auto">
      ...
      <ScrollAnimatedSection>
        <section className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section relative overflow-hidden">
          <div className="max-w-7xl mx-auto">
      ...
      <ScrollAnimatedSection>
        <section id="partners" className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section" data-testid="section-partners">
        <div className="max-w-7xl mx-auto">
      ...
      <ScrollAnimatedSection>
        <section className="py-8 px-6 sm:px-8 lg:px-12 neumorphic-section" data-testid="section-cta">
        <div className="max-w-7xl mx-auto">
          <CTABand
