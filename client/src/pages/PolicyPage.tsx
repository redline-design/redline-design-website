        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Card className="rounded-2xl backdrop-blur-md bg-card/40 border-white/10">
              <CardContent className="p-8 md:p-12 prose prose-lg dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-foreground prose-strong:text-foreground prose-li:text-foreground">
                {content}
              </CardContent>
            </Card>
          </motion.div>
