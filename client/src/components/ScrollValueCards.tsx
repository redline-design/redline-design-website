    ...
    >
      <div className="mx-auto px-4 md:px-8 lg:px-12 max-w-7xl relative z-10 py-12 md:py-24">
        ...
        >
          ...
          <p className="text-white/50 text-sm md:text-base lg:text-lg max-w-xl mx-auto leading-relaxed">
            ...
            {(() => {
              ...
              return (
                ...
                >
                  {/* Card */}
                  <div 
                    className="relative rounded-2xl p-6 min-h-[340px] flex flex-col"
                    style={{
          ...
          {cards.map((card, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Card */}
                <div 
                  className="relative rounded-2xl p-5 lg:p-7 h-full flex flex-col transition-all duration-300"
                  style={{
                ...
                >
                  ...
                  {card.bullets ? (
                    <div className="flex-1 space-y-2.5">
                      {card.bullets.map((bullet, bulletIdx) => (
                        ...
                        >
                          ...
                          <span className="text-xs lg:text-sm text-white/60 leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                            {bullet}
                          </span>
                        </motion.div>
                      ))}
                    ...
                    <p 
                      className="text-xs lg:text-sm text-white/50 leading-relaxed flex-1 group-hover:text-white/70 transition-colors duration-300"
