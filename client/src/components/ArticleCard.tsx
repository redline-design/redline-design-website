  ...
  return (
    ...
    >
      <Link href={`/digital-marketing/${slug}`}>
        <Card
          className="h-full hover-elevate active-elevate-2 transition-all duration-300 rounded-2xl cursor-pointer backdrop-blur-md bg-card/40 border-white/10 card-float"
