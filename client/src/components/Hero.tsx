      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
        ...
        >
          <Link href="/book-a-demo">
            <div className="inline-flex items-center gap-2 px-6 py-2 border-2 border-primary bg-primary/10 rounded-full text-sm font-semibold uppercase tracking-wider text-white mb-8 cursor-pointer hover-elevate active-elevate-2 badge-pulse transition-all fill-on-hover">
